...
export const FavoriteIcon = ({ width, height, ...props }: FavoriteIconProps) => {
  return (
    <svg width={`${width}px`} height={`${height}px`} {...props} viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">

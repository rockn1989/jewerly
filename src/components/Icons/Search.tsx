...
export const SearchIcon = ({ width, height, ...props }: SearchIconProps) => {
  return (
    <svg width={`${width}px`} height={`${height}px`} {...props} viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
